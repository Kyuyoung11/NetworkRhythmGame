...
public class Game extends Thread {
	...
	public void screenDraw(Graphics2D g) {
		g.drawImage(noteRouteSImage, 50, 90, null);
		g.drawImage(noteRouteDImage, 146, 90, null);
		g.drawImage(noteRouteJImage, 242,90, null);
		g.drawImage(noteRouteKImage, 338, 90, null);
		
		g.drawImage(noteRouteLineImage, 50, 90, null);
	    g.drawImage(noteRouteLineImage, 146,90, null);
		g.drawImage(noteRouteLineImage, 242, 90, null);
		g.drawImage(noteRouteLineImage, 338, 90, null);
		g.drawImage(noteRouteLineImage, 434, 90, null);
		
		
		g.drawImage(gameInfoImage, 0, 660, null);
		g.drawImage(judgementLineImage, 50, 580, null);
		...
		g.drawString("D", 93, 609);
		g.drawString("F", 189, 609);
		g.drawString("J", 285, 609);
		g.drawString("K", 381, 609);
